...
<html>
  ...
  <body>
   		<center>
   			...
   			<form action="${pageContext.request.contextPath }/AddProductsServlet" method="post" onsubmit="return checkForm()">
   				<table width="500" cellspacing="0" border="1">
   					<tr>
   						...
   						<td>
   							...
   							<a href="${pageContext.request.contextPath }/addBigType1">添加大类</a>
   						</td>
   					</tr>
   					<tr>
   						<td>选择小类:</td>
   						<td>
   							...
   							<a href="${pageContext.request.contextPath }/smalltype/GetAllBigTypeServlet">添加小类</a>
   						</td>
   					</tr>
   					<tr>
   						<td>产品名称:</td>
