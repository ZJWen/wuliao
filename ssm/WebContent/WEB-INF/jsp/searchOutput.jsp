...
<html>
  ...
  <body>
   		...
   		<h3><a href="${pageContext.request.contextPath }/pList.do">返回主页</a></h3>
   			<form action="${pageContext.request.contextPath }/SearchOutputByKeywordServlet" method="post" onsubmit="return checkForm()">
   			<table width="800" cellspacing="0" border="1">
   				...
   				<tr align="center">
   					...
   					<input type="button" value="按名称分组查询" onclick="groupByPro1()"/>
   					</td>
   				</tr>
